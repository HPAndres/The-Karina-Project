var typed = new Typed(".multiple-text", {
    strings: ["Un recordatorio de lo mucho que te amo", "Me haces falta (no importa cuando veas esto)", "Ya quiero verte :)"],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
...
window.addEventListener('load', () => {
    ...
    function init() {
        totalSeconds = Math.floor((new Date('09/11/2023') - new Date()) / 1000); 
        setTimeLeft();
